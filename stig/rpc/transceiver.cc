/* <stig/rpc/transceiver.cc> 

   Implements <stig/rpc/transceiver.h>.
...
TTransceiver::TDisconnected::TDisconnected()
    : runtime_error("Stig RPC transceiver hung up on") {}

TTransceiver::TPastEnd::TPastEnd()
    : logic_error("Stig RPC transceiver advanced past end of data") {}
