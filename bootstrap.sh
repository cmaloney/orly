...
#Build starsha
$CC "${common_flags[@]}" -DNDEBUG -Wold-style-cast -I$OUT $SRC/starsha/walk.cc $SRC/starsha/pipe.cc $SRC/starsha/obj_file.cc $SRC/starsha/nycr_file.cc $SRC/starsha/c_family_file.cc $SRC/starsha/cc_file.cc $SRC/starsha/bison_file.cc $SRC/starsha/starsha.cc $SRC/base/cmd.cc $SRC/starsha/c_file.cc $SRC/base/error.cc $SRC/starsha/exe_file.cc $SRC/starsha/note.cc $SRC/starsha/hdr_file.cc $SRC/base/demangle.cc $SRC/base/code_location.cc $SRC/starsha/thread_pool.cc $SRC/starsha/corpus.cc $SRC/starsha/flex_file.cc $SRC/starsha/runner.cc $SRC/base/make_dir.cc $SRC/base/thrower.cc -luuid -ldl -o $SRC/tools/starsha
