...
/* Returns the value mapped to the given key.  If the value doesn't appear in the container, returns
 * a default. */
template <typename TContainer>
const typename TContainer::mapped_type &FindOrDefault(const TContainer &container,
...
/* Returns the value mapped to the given key.  If the value doesn't appear in the container, the
 * default value is inserted and returned. */
template <typename TContainer>
const typename TContainer::mapped_type &FindOrInsert(TContainer &container,
                                                     const typename TContainer::key_type &key,
                                                     const typename TContainer::mapped_type &def) {
...
/* Inserts the pointer-type value into the associative container under the given key.  If the
   container already contains a value for the key,
